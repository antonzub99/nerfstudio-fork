    ...
    tyro.extras.subcommand_type_from_defaults(
        {
            ...
            "depth-data": NerfstudioDSDataParserConfig(),
        },
...
class DSDataManager(DataManager):  # pylint: disable=abstract-method
    ...
    def next_train(self, step: int) -> Tuple[RayBundle, Dict]:
        ...
        ray_indices = batch["indices"]
        depth_indices = depth_batch["depth_indices"]
        depth_coord = depth_batch["coord"]
        
        batch["depth"] = depth_batch["depth"]
        batch["weight"] = depth_batch["weight"]
